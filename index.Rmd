...
# write.csv(packages_list, "misc/list_pckg.csv", row.names = FALSE)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
packages <- read.csv("list_pckg.csv", stringsAsFactors = FALSE) |> unlist()
...
También se pueden instalar manualmente los paquetes siguiendo las instrucciones de la secciones [Usando las herramientas de RStudio] o [Usando la consola].
