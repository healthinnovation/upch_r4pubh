...
x <- read.csv("../list_pckg.csv", stringsAsFactors = F, 
              col.names = "Packages") %>% unlist()
z <- sort(x)
...
Verificar que los paquetes se han instalado correctamente en la parte inferior derecha de RStudio, pestaña "Packages".
